    ...
    <div className="min-h-screen bg-gradient-primary flex items-center justify-center pt-24 pb-16">
      <div className="max-w-lg w-full mx-4">
        <div className="text-center mb-10">
          ...
          <p className="text-white/70 text-xs">登录您的账户，继续AI创业之旅</p>
        </div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between mb-6">
              <label className="flex items-center gap-2">
                ...
                />
                <span className="text-white/80 text-xs">记住我</span>
              </label>
              <Link to="/" className="text-indigo-400 hover:text-indigo-300 text-xs">
                忘记密码？
              </Link>
            </div>
          ...
          <div className="mt-8">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-gradient-card text-white/60 text-xs">或使用以下方式登录</span>
              </div>
            </div>
