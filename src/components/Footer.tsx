    ...
    <footer className="bg-gradient-to-b from-[#0A1628] to-black pt-16 pb-8">
      <div className="max-w-5xl mx-auto px-6 sm:px-8 lg:px-12">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-12">
          <div className="col-span-2 md:col-span-4 lg:col-span-1">
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2 text-white text-sm">
                ...
                <span>contact@panduora.com</span>
              </div>
              <div className="flex items-center gap-2 text-white text-sm">
          ...
          <div>
            <h4 className="text-white font-semibold mb-4">支持帮助</h4>
            <ul className="space-y-2">
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-6">
              <Link to="/" className="text-white text-sm hover:text-white transition-colors">
                服务条款
              </Link>
              <Link to="/" className="text-white text-sm hover:text-white transition-colors">
                隐私政策
